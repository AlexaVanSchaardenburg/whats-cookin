...
describe('Save recipes', () => {
  ...
  it('Should be able to remove a recipe from a users recipes to cook array', () => {

    const userWithRecipes1 = saveRecipe(user, recipe1)
    const userWithRecipes2 = saveRecipe(userWithRecipes1, recipe2)
    

    deleteRecipe(userWithRecipes2, recipe2)

    expect(userWithRecipes2.recipesToCook).to.deep.equal([{
      "id": 595736,
      "image": "https://spoonacular.com/recipeImages/595736-556x370.jpg",
      "ingredients": [
        {
